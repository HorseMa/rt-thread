...
void rt_hw_spi_init(void)
{
    ...
    /* attach enc28j60 cs */
    {
        ...
        static struct stm32_spi_cs  enc28j60;
        ...
        enc28j60.GPIOx = GPIOA;
        enc28j60.GPIO_Pin = GPIO_Pin_4;

        GPIO_InitStructure.GPIO_Pin = enc28j60.GPIO_Pin;
        GPIO_Init(enc28j60.GPIOx, &GPIO_InitStructure);
        GPIO_SetBits(enc28j60.GPIOx, enc28j60.GPIO_Pin);

        /* spi device name spi10 */
